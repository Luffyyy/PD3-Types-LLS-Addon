...
---@enum EPostProcessVolumeSettingsPolicy
EPostProcessVolumeSettingsPolicy = {
    Local = 0,
    External = 1,
    Max = 2,
    EPostProcessVolumeSettingsPolicy_MAX = 3,
}
...
---@enum ESBZIrradianceVolumeVisibilityMethod
ESBZIrradianceVolumeVisibilityMethod = {
    VSM32 = 0,
    ESM16 = 1,
    ESM8 = 2,
    SH = 3,
    Disabled = 4,
    Max = 5,
    ESBZIrradianceVolumeVisibilityMethod_MAX = 6,
}

---@enum ESBZSparseIrradianceVolumeEmptySpaceResolution
ESBZSparseIrradianceVolumeEmptySpaceResolution = {
    Normal = 0,
    High = 1,
    Max = 2,
    ESBZSparseIrradianceVolumeEmptySpaceResolution_MAX = 3,
}

---@enum ESBZSparseIrradianceVolumeResolution
ESBZSparseIrradianceVolumeResolution = {
    Low = 0,
    Normal = 1,
    High = 2,
    Epic = 3,
    Max = 4,
    ESBZSparseIrradianceVolumeResolution_MAX = 5,
}
...
ETeleportType = {
    None = 0,
    TeleportPhysics = 1,
    TeleportPhysicsSimulatedOnly = 2,
    ResetPhysics = 3,
    ETeleportType_MAX = 4,
}
...
EViewModeIndex = {
    ...
    VMI_LODProblemColoration = 29,
    VMI_ReflectionComplexity = 30,
    VMI_ReflectionCoverage = 31,
    VMI_Max = 32,
    VMI_Unknown = 255,
    VMI_MAX = 256,
}
