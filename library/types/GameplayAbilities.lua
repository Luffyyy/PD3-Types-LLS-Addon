...
---@field MaximumDownwardOffset float
...
---@field bIncludeOverlaps boolean
...
---@field bUseOriginalContext boolean
...
---@field GameplayEffectLevel float
---@field OriginalDuration float
...
---@param NewOwnerActor AActor
---@param NewAvatarActor AActor
function UAbilitySystemComponent:Multicast_SetOwnerAvatarActor(NewOwnerActor, NewAvatarActor) end
---@param NewOwnerActor AActor
function UAbilitySystemComponent:Multicast_SetOwnerActor(NewOwnerActor) end
---@param NewAvatarActor AActor
function UAbilitySystemComponent:Multicast_SetAvatarActor(NewAvatarActor) end
...
---@field CachedOwningAbilitySystemComponent UAbilitySystemComponent
UAttributeSet = {}
...
---@field bProcessGameplayCueExecute boolean
