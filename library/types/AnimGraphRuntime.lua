...
---@field bUpdateAlphaCurveDuringEvaluation boolean
...
---@field bEnableSyncGroup boolean
---@field StartPosition float
---@field BlendSpace UBlendSpaceBase
---@field bPreventBlendFilterReinit boolean
...
---@field LODInterpolateTime float
---@field LODInterpolateTimer float
---@field CurveNamesToIgnore TArray<FName>
...
---@field TranslationAffectedAxis FVector
...
---@field AlphaInputType EAnimAlphaInputType
---@field bAlphaBoolEnabled boolean
---@field EnableAutoAimOffsetBlend boolean
---@field AimOffsetChangeBlendTime float
...
---@field SectionBlendLODThreshold int32
FAnimNode_Slot = {}
...
---@field EffectorLocation FVector
---@field EffectorTarget FBoneSocketTarget
---@field bAutoJointTarget boolean
---@field AutoJointTargetSourceOrientationWeight float
