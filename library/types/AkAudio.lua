...
function AAkAcousticPortal:SetExtent(Extent) end
...
---@field MinDistanceThresholdForUpdate float
---@field MinUpdateTime float
...
---@param bVal boolean
---@param Radius float
function UAkComponent:ShowStaticSoundSource(bVal, Radius) end
---@param bVal boolean
---@param Radius float
function UAkComponent:ShowStaticSoundAttenuation(bVal, Radius) end
---@param bVal boolean
---@param Radius float
function UAkComponent:ShowSoundObstruction(bVal, Radius) end
---@param bVal boolean
function UAkComponent:ShowSoundEvent(bVal) end
---@param bVal boolean
---@param Radius float
function UAkComponent:ShowDynamicSoundSource(bVal, Radius) end
---@param bVal boolean
---@param Radius float
function UAkComponent:ShowDynamicSoundAttenuation(bVal, Radius) end
---@param bVal boolean
function UAkComponent:ShowAudioBank(bVal) end
...
---@param bVal boolean
---@param List FString
function UAkComponent:SetSoundSourceFilter(bVal, List) end
...
---@param bVal boolean
function UAkComponent:GetSoundSourceFilter(bVal) end
---@return float
function UAkComponent:GetAttenuationRadius() end
---@param bVal boolean
function UAkComponent:EnableSoundSourceFilter(bVal) end
---@param bVal boolean
function UAkComponent:EnableSoundObstruction(bVal) end
---@param bVal boolean
function UAkComponent:EnableDebugSoundObstruction(bVal) end
...
---@param Type ESBZAkPoolType
---@param AutoDestroy boolean
---@return UAkComponent
function UAkGameplayStatics:SpawnAkComponentAtLocation(WorldContextObject, AkEvent, Location, Orientation, AutoPost, EventName, Type, AutoDestroy) end
---@param SwitchValue UAkSwitchValue
---@param Actor AActor
...
---@param ID FAkOutputDeviceID
---@return int32
function UAkGameplayStatics:RemoveOutput(ID) end
---@param TriggerValue UAkTrigger
---@param Actor AActor
---@param Trigger FName
...
---@return int32
function UAkGameplayStatics:AddOutput(in_Settings) end
...
---@field MemoryBudget uint32
---@field MasterVolumeRTPC FString
UAkSettings = {}
