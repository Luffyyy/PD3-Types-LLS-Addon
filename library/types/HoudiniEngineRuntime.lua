...
---@field MeshComponentsMaterials TArray<FString>
...
---@field BlueprintStaticMeshes TArray<UHoudiniInputStaticMesh>
...
---@field VertexInstanceNormals TArray<FVector>
---@field VertexInstanceUTangents TArray<FVector>
---@field VertexInstanceVTangents TArray<FVector>
