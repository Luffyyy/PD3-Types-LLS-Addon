...
---@field ClothBlendInTime float
---@field ClothNewlyRenderedBlendInTime float
---@field ClothBlendOutTime float
---@field bOptimizeUsingRenderedOnScreen boolean
---@field DistFromCameraToBeConsideredClose float
---@field RenderedOnScreenTimeTolerance float
