...
---@param bEnable boolean
function UAIPerceptionComponent:SetAllSenseEnabled(bEnable) end
...
---@field bUseHorizontalPlanes boolean
---@field VerticalVisionOffsetTop float
---@field VerticalVisionOffsetBottom float
...
---@field PlayerTeamId uint8
---@field PlayerImportanceBoost float
UAISense_Sight = {}
...
---@class UBTComposite_Switch : UBTCompositeNode
---@field CorrespondancyMap TMap<int32, int32>
...
---@field bUseBBPrecision boolean
---@field PrecisionBBKey FBlackboardKeySelector
...
---@param bEnable boolean
---@param bUpdateAgent boolean
function UCrowdFollowingComponent:SetCrowdSimplified(bEnable, bUpdateAgent) end
...
---@field bSingleAreaVisibilityOptimization boolean
---@field bEarlyReachTestOptimization boolean
