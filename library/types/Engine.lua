...
---@field bReplicateHidden boolean
...
---@field bWantsDetailedDamageEventsEx boolean
...
---@field bActorEnableIgnoredCollision boolean
...
---@field bActorDestroyedByNetForce boolean
...
---@field OnSBZTakeRadialDamage FActorOnSBZTakeRadialDamage
---@field OnSBZTakeOverlapDamage FActorOnSBZTakeOverlapDamage
---@field OnSBZTakePointDamageEx FActorOnSBZTakePointDamageEx
---@field OnSBZTakeRadialDamageEx FActorOnSBZTakeRadialDamageEx
...
---@param bNewActorEnableIgnoredCollision boolean
function AActor:SetActorEnableIgnoredCollision(bNewActorEnableIgnoredCollision) end
...
function AActor:SBZReceiveRadialDamage(DamageReceived, DamageType, Origin, Params, HitInfos, InstigatedBy, DamageCauser) end
---@param Damage float
---@param DamageType UDamageType
---@param OriginDirection FVector
---@param OverlapHitInfos TArray<FHitResult>
---@param InstigatedBy AController
---@param DamageCauser AActor
function AActor:SBZReceiveOverlapDamage(Damage, DamageType, OriginDirection, OverlapHitInfos, InstigatedBy, DamageCauser) end
...
---@return boolean
function AActor:GetActorEnableIgnoredCollision() end
---@return boolean
...
function AActor:ClientServerNetReadyReply() end
---@param Damage float
---@param Origin FVector
---@param Params FRadialDamageParams
---@param HitInfo FHitResult
---@return float
function AActor:CalculateDamageFalloff(Damage, Origin, Params, HitInfo) end
---@param PrerequisiteComponent UActorComponent
...
---@param Component UActorComponent
function AActor:AddInstanceComponent(Component) end
...
---@field OnInstigatedPointDamage FControllerOnInstigatedPointDamage
---@field OnInstigatedRadialDamage FControllerOnInstigatedRadialDamage
---@field OnInstigatedOverlapDamage FControllerOnInstigatedOverlapDamage
AController = {}
...
---@param Params FRadialDamageParams
---@param HitInfos TArray<FHitResult>
function AController:ReceiveInstigatedRadialDamage(Damage, DamageType, DamagedActor, DamageCauser, Origin, Params, HitInfos) end
---@param Damage float
---@param DamageType UDamageType
---@param DamagedActor AActor
---@param DamageCauser AActor
...
---@param HitInfo FHitResult
function AController:ReceiveInstigatedPointDamage(Damage, DamageType, DamagedActor, DamageCauser, ShotDirection, HitInfo) end
---@param Damage float
---@param DamageType UDamageType
---@param DamagedActor AActor
---@param DamageCauser AActor
---@param OriginDirection FVector
---@param HitInfos TArray<FHitResult>
function AController:ReceiveInstigatedOverlapDamage(Damage, DamageType, DamagedActor, DamageCauser, OriginDirection, HitInfos) end
---@param Damage float
---@param DamageType UDamageType
---@param DamagedActor AActor
---@param DamageCauser AActor
...
---@class ADebugSplineActor : AActor
...
---@field bAutomaticallyRegisterAsStimulusSource boolean
---@field PlayerState APlayerState
...
---@field OnTopPassDefaultFOV float
...
---@param NewFOV float
function APlayerController:TFOV(NewFOV) end
...
---@param AmountDepressed float
---@param bGamepad boolean
---@return boolean
function APlayerController:InputKey(Key, EventType, AmountDepressed, bGamepad) end
---@param SizeX int32
---@param SizeY int32
...
---@field PostProcessSettingsConfig UPostProcessSettingsConfig
---@field PostProcessVolumeSettingsPolicy EPostProcessVolumeSettingsPolicy::Type
APostProcessVolume = {}
...
---@class ASBZAIVisibilityVolume : AVolume
---@field bExcluder boolean
ASBZAIVisibilityVolume = {}



---@class ASBZIrradianceFadingVolume : AVolume
ASBZIrradianceFadingVolume = {}


---@class ASBZIrradianceVolume : AVolume
---@field IrradianceVolumeComponent USBZIrradianceVolumeComponent
ASBZIrradianceVolume = {}



---@class ASBZLightVolume : AVolume
---@field PositiveXFadeDistance float
---@field NegativeXFadeDistance float
---@field PositiveYFadeDistance float
---@field NegativeYFadeDistance float
---@field PositiveZFadeDistance float
---@field NegativeZFadeDistance float
ASBZLightVolume = {}

---@param PX FLinearColor
---@param NX FLinearColor
---@param PY FLinearColor
---@param NY FLinearColor
---@param PZ FLinearColor
---@param NZ FLinearColor
function ASBZLightVolume:ComputePlanes(PX, NX, PY, NY, PZ, NZ) end


---@class ASBZSparseIrradianceVolume : AVolume
---@field SBZSparseIrradianceVolumeComponent USBZSparseIrradianceVolumeComponent
ASBZSparseIrradianceVolume = {}



---@class ASBZVisibilityOverrideVolume : AVolume
---@field SBZVisibilityOverrideComponent USBZVisibilityOverrideComponent
ASBZVisibilityOverrideVolume = {}



---@class ASBZVisibilityVolume : AVolume
---@field SBZVisibilityComponent USBZVisibilityComponent
ASBZVisibilityVolume = {}
...
---@field IrradianceVolumeIntensityBias float
---@field bUseSoftwareOcclusion boolean
...
---@field bHostMigrationRebuildingActors boolean
...
---@field StartJumpBlending float
---@field JumpBlendingDuration float
---@field UpdateEvalDataCount uint16
---@field bWaitBlendInBeforeEval boolean
...
---@field EnableAutoSequenceBlend boolean
---@field SequenceChangeBlendTime float
---@field bSaveWeightInCurve boolean
---@field bSaveWeightOnlyIfBigger boolean
---@field SaveWeightCurveName FName
...
---@field bIgnoredCollisionEnabled boolean
---@field bIgnoreCollisionSettingFromBodySetup boolean
---@field bSameObjectTypeOnlySelfCollision boolean
...
---@class FContrastSettings
---@field MinIntensity float
---@field MaxIntensity float
---@field MappedMinIntensity float
---@field MappedMaxIntensity float
FContrastSettings = {}
...
---@field bOverride_TopPassDepthOfFieldFocalDistance boolean
---@field bOverride_TopPassDepthOfFieldFstop boolean
---@field bOverride_TopPassDepthOfFieldDepthBlurAmount boolean
---@field bOverride_TopPassDepthOfFieldDepthBlurRadius boolean
...
---@field bRepState boolean
---@field State uint8
---@field MaxStateBitCount uint8
FRepMovement = {}
...
---@class FSBZOverlapDamageEvent : FDamageEvent
---@field Damage float
---@field OriginDirection FVector_NetQuantizeNormal
---@field ComponentHitResults TArray<FHitResult>
FSBZOverlapDamageEvent = {}



---@class FSBZPathOffset
---@field Offset float
...
---@class FSBZSectionBlendInfo
---@field BlendToSectionName FName
---@field BlendTime float
FSBZSectionBlendInfo = {}
...
function UActorComponent:SetCanEverAffectNavigation(bRelevant) end
...
---@param bNewReplicates boolean
---@param bNewIsActive boolean
function UActorComponent:Multicast_ReplicatesIsActive(bNewReplicates, bNewIsActive) end
---@param bNewReplicates boolean
function UActorComponent:Multicast_Replicates(bNewReplicates) end
---@param bNewIsActive boolean
function UActorComponent:Multicast_IsActive(bNewIsActive) end
---@param Object UObject
...
---@field SectionBlends TMap<FName, FSBZSectionBlendInfo>
---@field bPlayAfterBlendIn boolean
---@field bAlwaysTick boolean
---@field bAutoStopWhenMoving boolean
---@field bAutoSwitchSectionBasedOnTag boolean
---@field AutoSwitchSectionOwningTag FGameplayTag
---@field AutoSwitchSectionName FName
---@field AutoSwitchAllowedSectionNames TArray<FName>
...
---@field bContinueRecycledSystems boolean
...
---@class UAnimNotifyState_WarpingBase : UAnimNotifyState
...
---@field AuthoredSyncMarkers TArray<FAnimSyncMarker>
---@field bStripRawCurveDataOnCook boolean
...
---@field bLogInvalidSyncMarkers boolean
UBlendSpaceBase = {}
...
---@param PositionWS FVector
---@return boolean
function UBoxComponent:ContainsPoint(PositionWS) end


---@class UBoxReflectionCaptureComponent : UReflectionCaptureComponent
---@field BoxTransitionPositiveXDistance float
---@field BoxTransitionNegativeXDistance float
---@field BoxTransitionPositiveYDistance float
---@field BoxTransitionNegativeYDistance float
---@field BoxTransitionPositiveZDistance float
---@field BoxTransitionNegativeZDistance float
...
---@field PerchRadiusExpanderMinSpeed float
...
---@field bSkipImpulseFromPhysicsInteraction boolean
...
---@field CornerMinSlowdownScale float
---@field CornerSlowdownRadius float
---@field CornerMinSlowdownSpeed float
---@field GoalSlowdownRadius float
---@field GoalMinSlowdownScale float
---@field GoalMinSlowdownSpeed float
...
---@return float
function UCharacterMovementComponent:GetValidPerchRadius(InHit) end
---@return float
...
---@field DamageFalloff float
---@field bApplyDamageImpulseAtImpactLocation boolean
UDamageType = {}
...
---@field bCachedWholeSceneShadowMap boolean
---@field bUseLightOriginForWholeSceneShadowMap boolean
---@field WholeSceneShadowMapRadius float
---@field WholeSceneShadowsFarDistance float
...
---@field MaximumReplicationForceInitPropertiesCount int32
...
---@class UGameUserSettings : USaveGame
...
---@param Rotation FRotator
---@param LifeSpan float
---@param MaxInstances int32
---@return UDecalComponent
function UGameplayStatics:SpawnDecalAtLocation(WorldContextObject, DecalMaterial, DecalSize, Location, Rotation, LifeSpan, MaxInstances) end
---@param WorldContextObject UObject
...
---@param SlotName FString
---@param UserIndex int32
---@param SaveData TArray<uint8>
---@return USaveGame
function UGameplayStatics:LoadGameFromMemory(SlotName, UserIndex, SaveData) end
---@param WorldContextObject UObject
---@return boolean
...
---@field MinDistanceFadeRange float
---@field VolumetricMaxDrawDistance float
---@field VolumetricMaxDistanceFadeRange float
---@field CastShadowsMaxDrawDistance float
---@field CastShadowsDistanceFadeRange float
---@field AnimationPlaybackSpeed float
---@field AnimationOffset float
---@field AnimationIntensityCurve UCurveFloat
---@field AnimationColorCurve UCurveLinearColor
...
---@field bVisibleInIrradianceCapturesOnly boolean
ULightComponent = {}
...
---@param Speed float
function ULightComponent:SetAnimationPlaybackSpeed(Speed) end
---@param Offset float
function ULightComponent:SetAnimationOffset(Offset) end
---@param IntensityCurve UCurveFloat
function ULightComponent:SetAnimationIntensityCurve(IntensityCurve) end
---@param ColorCurve UCurveLinearColor
function ULightComponent:SetAnimationColorCurve(ColorCurve) end
---@param bNewValue boolean
...
---@return FLinearColor
function ULightComponent:ComputeAnimatedLightColor() end
---@return float
function ULightComponent:ComputeAnimatedIntensity() end
---@return FLinearColor
function ULightComponent:ComputeAnimatedColor() end
...
---@field LightVolume ASBZLightVolume
---@field bUseLightVolumeForOcclusionQueries boolean
---@field bUseLightVolumeAsProxyShape boolean
---@field VolumetricAttenuationRadius float
...
---@class UMigratingNetGame : UPendingNetGame
UMigratingNetGame = {}
...
---@field bDontGenerateNavMeshOnTop boolean
UNavCollisionBase = {}
...
---@field SpikeDeltaTimeThreshold float
...
---@field PredefinedNetworkAssets TArray<TSoftObjectPtr<UObject>>
---@field PredefinedNetworkActorClasses TArray<TSoftClassPtr<AActor>>
UNetworkSettings = {}
...
---@field bDisableSubsteppingOnDedicatedServer boolean
...
---@param AxisKey FKey
---@param InIsInverted boolean
function UPlayerInput:SetInvertAxisKey(AxisKey, InIsInverted) end
...
---@class UPostProcessSettingsConfig : UObject
---@field Settings FPostProcessSettings
UPostProcessSettingsConfig = {}
...
---@field bGenerateOverlapEvents boolean
---@field bAlwaysGenerateOverlap boolean
...
---@field bVisibleInRayTracing boolean
---@field bVisibleOnlyInIrradianceCaptures boolean
---@field bRenderInMainPass boolean
---@field bRenderInDepthPass boolean
---@field bRenderInTopPass boolean
---@field bGISpecularEnabled boolean
---@field bSSREnabled boolean
---@field bForceVoxelizationInSparseIrradianceTrees boolean
---@field bRenderInDepthPrePass boolean
...
---@field bCastDirectionalLightShadow boolean
...
---@field bOverrideDontGenerateNavMeshOnTop boolean
---@field bDontGenerateNavMeshOnTop boolean
...
---@field LightingAttachmentRoot UPrimitiveComponent
...
---@field MoveIgnoreStartPenetratingActors TArray<AActor>
...
---@field RenderSectionInCustomDepthPass TArray<boolean>
...
---@param bValue boolean
function UPrimitiveComponent:SetSSREnabled(bValue) end
...
---@return boolean
function UPrimitiveComponent:SetRenderSectionInCustomDepthPass(Section, bRender) end
---@param bValue boolean
function UPrimitiveComponent:SetRenderInTopPass(bValue) end
---@param bValue boolean
...
---@param NewMinDistance float
function UPrimitiveComponent:SetMinCullDistance(NewMinDistance) end
---@param MaterialSlotName FName
---@param Material UMaterialInterface
...
---@param InLightingAttachmentRoot UPrimitiveComponent
function UPrimitiveComponent:SetLightingAttachmentRoot(InLightingAttachmentRoot) end
...
---@param bNewIgnoredCollisionEnabled boolean
function UPrimitiveComponent:SetIgnoredCollisionEnabled(bNewIgnoredCollisionEnabled) end
---@param bValue boolean
function UPrimitiveComponent:SetHiddenInSceneCapture(bValue) end
---@param bValue boolean
function UPrimitiveComponent:SetGISpecularEnabled(bValue) end
...
function UPrimitiveComponent:SetDefaultCustomPrimitiveData(DataIndex, Values) end
---@param DataIndex int32
---@param Value FVector4
...
---@param Values TArray<float>
function UPrimitiveComponent:SetCustomPrimitiveData(Values) end
...
function UPrimitiveComponent:SetCollisionEnabledForce(NewType) end
---@param NewType ECollisionEnabled::Type
...
---@param NewCastShadow boolean
function UPrimitiveComponent:SetCastDirectionalLightShadow(NewCastShadow) end
...
---@return boolean
function UPrimitiveComponent:K2_IsIgnoredCollisionEnabled() end
---@return boolean
...
function UPrimitiveComponent:IgnoreStartPenetratingActorWhenMoving(Actor, bShouldIgnore) end
---@param Component UPrimitiveComponent
---@param bShouldIgnore boolean
...
---@return UMaterialInterface
function UPrimitiveComponent:GetMaterialFromSectionIndex(SectionIndex) end
---@param FaceIndex int32
---@param SectionIndex int32
---@return UMaterialInterface
...
---@return boolean
function UPrimitiveComponent:GetIgnoredCollisionEnabled() end
---@return boolean
function UPrimitiveComponent:GetGenerateOverlapEvents() end
---@param DataIndex int32
---@return FVector4
function UPrimitiveComponent:GetDefaultCustomPrimitiveDataVector4(DataIndex) end
---@param DataIndex int32
---@return FVector
function UPrimitiveComponent:GetDefaultCustomPrimitiveDataVector3(DataIndex) end
---@param DataIndex int32
---@return FVector2D
function UPrimitiveComponent:GetDefaultCustomPrimitiveDataVector2(DataIndex) end
---@param DataIndex int32
---@return float
function UPrimitiveComponent:GetDefaultCustomPrimitiveDataFloat(DataIndex) end
---@param DataIndex int32
---@return FVector4
function UPrimitiveComponent:GetCustomPrimitiveDataVector4(DataIndex) end
---@param DataIndex int32
---@return FVector
function UPrimitiveComponent:GetCustomPrimitiveDataVector3(DataIndex) end
---@param DataIndex int32
---@return FVector2D
function UPrimitiveComponent:GetCustomPrimitiveDataVector2(DataIndex) end
---@param DataIndex int32
---@return float
function UPrimitiveComponent:GetCustomPrimitiveDataFloat(DataIndex) end
---@param Channel ECollisionChannel
...
---@return TArray<float>
function UPrimitiveComponent:GetArrayCustomPrimitiveData() end
---@return float
...
function UProjectileMovementComponent:MoveInterpolationTarget(OldLocation, OldRotation) end
---@param NewVelocity FVector
---@return FVector
...
---@field Brightness float
---@field ContrastSettings FContrastSettings
...
---@field bAllowSoftwareOcclusionCulling boolean
...
---@class USBZIrradianceVolumeComponent : USceneComponent
---@field SamplesX uint32
---@field SamplesY uint32
---@field SamplesZ uint32
---@field Intensity float
---@field SpecularIntensity float
---@field MinimumRoughness float
---@field BounceCount int32
---@field bCaptureStaticLightsOnly boolean
---@field bCaptureEmissive boolean
---@field bCaptureSkyColor boolean
---@field bCaptureFog boolean
---@field bRadianceFiltering boolean
---@field CaptureResolution uint32
---@field IrradianceResolution uint32
---@field VisibilityResolution uint32
---@field VisibilityMethod ESBZIrradianceVolumeVisibilityMethod::Type
---@field LightingChannels FLightingChannels
---@field MaxDrawDistance float
---@field MaxDistanceFadeRange float
---@field PositiveXFadeDistance float
...
---@field PositiveZFadeDistance float
---@field NegativeZFadeDistance float
---@field DistanceFieldSamplesX uint32
---@field DistanceFieldSamplesY uint32
---@field DistanceFieldSamplesZ uint32
USBZIrradianceVolumeComponent = {}



---@class USBZIrradianceVolumeLineBatchComponent : ULineBatchComponent
USBZIrradianceVolumeLineBatchComponent = {}


---@class USBZLightProxy : UObject
USBZLightProxy = {}


---@class USBZMaterialExpressionRoughGlassTexture : UMaterialExpression
---@field UVs FExpressionInput
---@field Roughness FExpressionInput
USBZMaterialExpressionRoughGlassTexture = {}



---@class USBZPoseableSkeletalMeshComponent : USkeletalMeshComponent
USBZPoseableSkeletalMeshComponent = {}

---@param BoneName FName
---@param InTransform FTransform
---@param BoneSpace EBoneSpaces::Type
function USBZPoseableSkeletalMeshComponent:SetBoneTransformByName(BoneName, InTransform, BoneSpace) end
---@param BoneName FName
---@param InScale3D FVector
---@param BoneSpace EBoneSpaces::Type
function USBZPoseableSkeletalMeshComponent:SetBoneScaleByName(BoneName, InScale3D, BoneSpace) end
---@param BoneName FName
---@param InRotation FRotator
---@param BoneSpace EBoneSpaces::Type
function USBZPoseableSkeletalMeshComponent:SetBoneRotationByName(BoneName, InRotation, BoneSpace) end
---@param BoneName FName
---@param InLocation FVector
---@param BoneSpace EBoneSpaces::Type
function USBZPoseableSkeletalMeshComponent:SetBoneLocationByName(BoneName, InLocation, BoneSpace) end
---@param BoneName FName
function USBZPoseableSkeletalMeshComponent:ResetBoneTransformByName(BoneName) end
---@param BoneName FName
---@param BoneSpace EBoneSpaces::Type
---@return FTransform
function USBZPoseableSkeletalMeshComponent:GetBoneTransformByName(BoneName, BoneSpace) end
---@param BoneName FName
---@param BoneSpace EBoneSpaces::Type
---@return FVector
function USBZPoseableSkeletalMeshComponent:GetBoneScaleByName(BoneName, BoneSpace) end
---@param BoneName FName
---@param BoneSpace EBoneSpaces::Type
---@return FRotator
function USBZPoseableSkeletalMeshComponent:GetBoneRotationByName(BoneName, BoneSpace) end
---@param BoneName FName
---@param BoneSpace EBoneSpaces::Type
---@return FVector
function USBZPoseableSkeletalMeshComponent:GetBoneLocationByName(BoneName, BoneSpace) end
---@param InComponentToCopy USkeletalMeshComponent
function USBZPoseableSkeletalMeshComponent:CopyPoseFromSkeletalComponent(InComponentToCopy) end


---@class USBZSparseIrradianceVolumeComponent : USceneComponent
---@field Intensity float
---@field EndIntensity float
---@field SpecularIntensity float
---@field CharacterIntensityMultiplier float
---@field MinimumRoughness float
---@field Resolution ESBZSparseIrradianceVolumeResolution::Type
---@field EmptySpaceResolution ESBZSparseIrradianceVolumeEmptySpaceResolution::Type
---@field bVoxelizeNavigationMesh boolean
---@field NavigationMeshHeight float
---@field ExcludedActorsForVoxelTree TArray<AActor>
---@field LightingChannels FLightingChannels
---@field MaxDrawDistance float
---@field MaxDistanceFadeRange float
---@field BounceCount int32
...
---@field bCaptureFog boolean
---@field bRadianceFiltering boolean
---@field bEnableAutomaticSizeDistanceCulling boolean
---@field CullDistanceFactor float
---@field CullStepDistance float
USBZSparseIrradianceVolumeComponent = {}

---@param NewIntensity float
function USBZSparseIrradianceVolumeComponent:SetSpecularIntensity(NewIntensity) end
---@param NewIntensity float
function USBZSparseIrradianceVolumeComponent:SetIntensity(NewIntensity) end
---@param NewIntensity float
function USBZSparseIrradianceVolumeComponent:SetEndIntensity(NewIntensity) end
---@param NewMultiplier float
function USBZSparseIrradianceVolumeComponent:SetCharacterIntensityMultiplier(NewMultiplier) end


---@class USBZVisibilityComponent : USceneComponent
USBZVisibilityComponent = {}


---@class USBZVisibilityOverrideComponent : USceneComponent
---@field VisibilityVolumesToExclude TArray<ASBZVisibilityVolume>
USBZVisibilityOverrideComponent = {}
...
---@field NetOldAttachChildren TArray<USceneComponent>
...
---@param bConsiderChildren boolean
---@return FBoxSphereBounds
function USceneComponent:GetTightBounds(bConsiderChildren) end
---@param InSocketName FName
...
---@param NewAreaClass TSubclassOf<UNavAreaBase>
function UShapeComponent:ChangeNavigationArea(NewAreaClass) end
...
---@field bUseModifiedATToExpressWorldRM boolean
...
---@field bIsAutonomousCharacterIdle boolean
---@field bOldForceRefPose boolean
---@field bShowPrePhysBones boolean
---@field bRequiredBonesUpToDate boolean
---@field bForceDisableEndPhysicsTick boolean
---@field bCachedAllBodiesAreSimulatingAndSleeping boolean
...
---@field CachedAllBodiesAreSimulatingAndSleepingFrame uint32
...
---@field bForceUseRootBoneTranslation boolean
...
---@field bPreviousRecentlyRendered boolean
---@field bNeedsToRefreshBoneTransforms boolean
...
---@field LastTickPoseFrame uint32
...
---@field SBZLightProxy USBZLightProxy
USpotLightComponent = {}
...
---@return FName
function UStaticMesh:GetMaterialSlotName(MaterialIndex) end
---@param MaterialSlotName FName
---@return int32
...
function UStaticMeshComponent:SetUseEmissiveForStaticLighting(NewValue) end
...
---@class UVoiceChannelSettings : UObject
---@field bIsBeaconVoiceCommunicationEnabled boolean
UVoiceChannelSettings = {}
