...
---@param InCasing ETextCasing
function UTextBlock:SetTextCasing(InCasing) end
---@param InText FText
...
---@param InAnimation UWidgetAnimation
---@return float
function UUserWidget:GetAnimationLength(InAnimation) end
---@param InAnimation UWidgetAnimation
---@return float
